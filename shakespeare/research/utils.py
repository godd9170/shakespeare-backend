...
def whois(email):  # get_contact
    ...
    if (company is None) or (company.get('domain',
                                         None) is None):  #if Clearbit can't find an org, or it doesn't have a domain don't bother associating an organization
